...
document.addEventListener('DOMContentLoaded', function () {
        ...
        if (event.target.classList.contains('mention-link')) {
            ...
            if (mentionedComment) {
                ...
                mentionContent.innerHTML = `
                    ...
                    <button id="scrollToCommentButton">해당 댓글로 이동</button>
                `;
                ...
                // "댓글로 이동" 버튼 숨기기
                const scrollToCommentButton = document.getElementById('scrollToCommentButton');
                if (scrollToCommentButton && scrollToCommentButton.textContent.includes("댓글로 이동")) {
                    scrollToCommentButton.style.display = 'none';
                }
            }
        }
    });
    ...
    function displayMzTopics(topics) {
        ...
        sortedTopics.slice(0, 5).forEach(topic => {
            ...
            topicDiv.classList.add('topic-item', 'mz-topic-item');
